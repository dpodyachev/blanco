...
player.prototype.play_now = function(item){
    ...
    try{
        ...
        if (this.cur_media_item.error){
            ...
            _debug('use_proxy 4 ======= '+uri, use_proxy);
...
_debug('is a proxy========');
            ...
            }else{_debug('dimaredirect1 ======== "'+uri+'"');
if (uri.substr(-5).indexOf("m3u")==1) {_debug('========short====');
                stb.Play('http://stalkertest.itvservices.net/stalker_portal/server/administrator/re.php?go='+uri);
} else {_debug('========long====');
                stb.Play(uri);}
            }
        }
