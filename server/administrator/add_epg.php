...
$row='INSERT INTO epg (ch_id,time,time_to,duration,name,real_id,descr) VALUES ';
$xml=simplexml_load_file($_FILES['userfile']['tmp_name']) or die("Error: Cannot create object");
foreach($xml->children() as $books) {
$row.="(2,'".
date('Y-m-d H:i:s',strtotime($books['start']))."','".
date('Y-m-d H:i:s',strtotime($books['stop']))."','".
(strtotime($books['stop'])-strtotime($books['start'])).
"','{$books->title}','2_".strtotime($books['start'])."','{$books->media}'),";
}
//$row="INSERT INTO epg (ch_id,time,time_to,duration,name,real_id,descr) VALUES (2,'2015-11-23 01:00:00','2015-11-23 05:30:00','16200','Le journal de la nuit','2_1448233200','http://739759477.r.worldcdn.net/12170/m3u8/1448470800.m3u8?03a416cb2a72ec0348326c16ac0162febe13a5f37f05727bee3b471e38eadfbb3f3eba086bb4aa908dd3e47c9dc9540d5fdb'),(2,'2015-11-23 07:00:00','2015-11-23 09:35:00','9300','Première édition','2_1448254800','http://739759477.r.worldcdn.net/12170/m3u8/1448460000.m3u8?03a416cb2a72ec0348326c16ac0162febe13a5f37f05727bee3b471e38eadfbb3f3eba086bb4aa908dd3e47c9dc9540d5fdb');";
$raw = Mysql::getInstance()->query(substr_replace($row,';',-1));
}}
...
<table class="list" align="center" border="0" cellpadding="0" cellspacing="0" width="400">
<tr>
    <td width="50%" align="right">EPG XML import:</td>
